...
public class ChinaDate {
    ...
    public String toString() {
        return "ChinaDate{" +
                "solarDate日期：=" + solarDate +
                ", lunar=农历：'" + lunar + '\'' +
                ", solar=公历：'" + solar + '\'' +
                ", isVacation=是否休假：" + isVacation +
                ", VacationName=假期名：'" + VacationName + '\'' +
                ", isWorkFlag=是否工作日：" + isWorkFlag +
                ", isSaturday=是否周六：" + isSaturday +
                ", isSunday=是否工作日：" + isSunday +
                '}';
    }
}
